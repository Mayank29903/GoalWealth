    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        <button
          ...
          className="rounded-md p-2 text-text_secondary transition-colors hover:bg-[#da38321a] hover:text-accent_red disabled:cursor-not-allowed disabled:opacity-45"
      ...
      <dl className="mt-3 grid grid-cols-2 gap-3 text-xs">
        <div className="min-w-0 rounded-md bg-card_background p-2">
          ...
          <dd className="font-semibold leading-tight text-primary_blue break-all [overflow-wrap:anywhere]">
            {formatCurrency(result?.requiredMonthlySIP || 0)}
          </dd>
        </div>
        <div className="min-w-0 rounded-md bg-card_background p-2">
          ...
          <dd className="font-semibold leading-tight text-text_primary break-all [overflow-wrap:anywhere]">
            {formatCurrency(result?.inflatedGoalValue || 0)}
          </dd>
        </div>
      </dl>
    </article>
